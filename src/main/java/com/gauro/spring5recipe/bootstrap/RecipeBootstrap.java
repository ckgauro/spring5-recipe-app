package com.gauro.spring5recipe.bootstrap;

import com.gauro.spring5recipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.info("onApplicationEvent is called ======>");
        getRecipes();
    ...
    private List<Recipe> getRecipes() {
        log.info("getRecipes is called ======>");
        List<Recipe> recipes = new ArrayList<>(2);
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByDescription("Each");

        if (!eachUomOptional.isPresent()) {
            log.info("Expected UOM Not found");
            throw new RuntimeException("Expected UOM Not found");
        }
        log.info(eachUomOptional.toString());
        ...
        if (!americanCategoryOptional.isPresent()) {
            log.info("Expected Category Not Found");
        ...
        log.info("Second Recipes are added========>");
